...
class VehicleDirective {
    ...
    getURL() {
        const encod = this.vehicle.vehicle.replace(/ /g, "+");
        return `${url} ${encod}`;
    }
}
...
VehicleDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineDirective"]({ type: VehicleDirective, selectors: [["", "appVehicle", ""]], hostBindings: function VehicleDirective_HostBindings(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function VehicleDirective_click_HostBindingHandler() { return ctx.onClick(); });
    } }, inputs: { vehicle: "vehicle", protocol: "protocol" } });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](VehicleDirective, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Directive"],
        args: [{
                selector: '[appVehicle]'
            }]
    }], function () { return [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Renderer2"] }, { type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] }]; }, { vehicle: [{
...
function VehicleComponent_li_11_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("vehicle", vehicle_r1)("protocol", true);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind1"](7, 6, vehicle_r1));
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](3);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtextInterpolate"](_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipeBind3"](10, 8, vehicle_r1.cost.amount, vehicle_r1.cost.currencyCode, "code"));
} }
class VehicleComponent {
}
VehicleComponent.ɵfac = function VehicleComponent_Factory(t) { return new (t || VehicleComponent)(); };
VehicleComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: VehicleComponent, selectors: [["app-vehicles"]], inputs: { vehicles: "vehicles" }, decls: 12, vars: 1, consts: [[1, "vehicles"], [1, "head-list"], [1, "head-list__num-list"], [1, "head-list__added"], [1, "head-list__vehicle"], [1, "head-list__price"], [1, "list"], ["class", "item", "appVehicle", "", 3, "vehicle", 4, "ngFor", "ngForOf"], ["appVehicle", "", 1, "item", 3, "vehicle"], [1, "item__index"], ["appVehicle", "", 1, "item__link", 3, "vehicle", "protocol"], [1, "item__vehicle"], [1, "item__price"]], template: function VehicleComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtemplate"](11, VehicleComponent_li_11_Template, 11, 12, "li", 7);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵadvance"](11);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵproperty"]("ngForOf", ctx.vehicles);
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["NgForOf"], _directives_vehicle_directive__WEBPACK_IMPORTED_MODULE_2__["VehicleDirective"]], pipes: [_pipes_transform_vehicle_pipe__WEBPACK_IMPORTED_MODULE_3__["TransformVehiclePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CurrencyPipe"]], styles: [".vehicles[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  flex-direction: column;\n}\n\n.head-list[_ngcontent-%COMP%] {\n  width: 750px;\n  display: flex;\n  text-align: center;\n}\n\n.head-list__num-list[_ngcontent-%COMP%] {\n  width: 10%;\n  margin-left: 1px;\n  padding: 10px;\n  background-color: #1E8A23;\n  color: #FFF;\n  text-transform: uppercase;\n}\n\n.head-list__added[_ngcontent-%COMP%] {\n  width: 25%;\n  margin-left: 1px;\n  padding: 10px;\n  background-color: #1E8A23;\n  color: #FFF;\n  text-transform: uppercase;\n}\n\n.head-list__vehicle[_ngcontent-%COMP%] {\n  width: 65%;\n  margin-left: 1px;\n  padding: 10px;\n  background-color: #1E8A23;\n  color: #FFF;\n  text-transform: uppercase;\n}\n\n.head-list__price[_ngcontent-%COMP%] {\n  width: 25%;\n  margin-left: 1px;\n  padding: 10px;\n  background-color: #1E8A23;\n  color: #FFF;\n  text-transform: uppercase;\n}\n\n.list[_ngcontent-%COMP%] {\n  list-style-type: none;\n  width: 750px;\n}\n\n.item[_ngcontent-%COMP%] {\n  display: flex;\n  cursor: pointe;\n}\n\n.item__index[_ngcontent-%COMP%] {\n  padding: 10px;\n  width: 10%;\n  border-bottom: solid 1px #1E8A23;\n  border-left: solid 1px #1E8A23;\n}\n\n.item__link[_ngcontent-%COMP%] {\n  padding: 10px;\n  width: 25%;\n  border-bottom: solid 1px #1E8A23;\n  border-left: solid 1px #1E8A23;\n}\n\n.item__vehicle[_ngcontent-%COMP%] {\n  padding: 10px;\n  width: 65%;\n  border-bottom: solid 1px #1E8A23;\n  border-left: solid 1px #1E8A23;\n}\n\n.item__price[_ngcontent-%COMP%] {\n  padding: 10px;\n  width: 25%;\n  border-bottom: solid 1px #1E8A23;\n  border-left: solid 1px #1E8A23;\n  border-right: solid 1px #1E8A23;\n}\n\n.block-link[_ngcontent-%COMP%] {\n  color: #F00;\n}\n\n.item-hover[_ngcontent-%COMP%]:hover {\n  background-color: #B1DDB3;\n  cursor: pointer;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
